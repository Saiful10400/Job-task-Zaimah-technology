...
const AdsBanner = () => {
  return (
    <div className="bg-[#FCD0CC] overflow-hidden h-[250px] mt-5 relative pl-[96px] mb-[60px]">
      ...
      <img
        className="absolute z-10 top-[81px]  right-[272px] scale-105"
        src={pleasures}
        alt="ads product image"
      />
      <img
        className="absolute z-10 top-[-80px]  right-[200px]"
        src={whiteTea}
        alt="ads product image"
      />
      <img
        className="absolute z-10 top-[-90px]  right-[-150px]"
        src={perfume}
        alt="ads product image"
      />
