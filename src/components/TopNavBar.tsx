...
const TopNavBar = () => {
    return (
        <div className="flex items-center justify-between px-[27px] py-[22px] ">

            <form className="min-w-[600px] relative">
            ...
            <nav className="flex items-center justify-end gap-[10px] min-w-[600px]">
